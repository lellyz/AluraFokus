...
const btnEditarTarefa               = document.querySelector('.app_button-edit');
...
function limparTxtAreaEsconderFormulario() {
    textArea.value = '';
...
function criarElementoTarefa (tarefa) {
    ...
    botao.onclick = () => {
        ...
        // if (textArea.value != tarefa.descricao) {
...
formularioAdicionarTarefa.addEventListener('submit', (evento) => {
    ...
    atualizarTarefas();
    limparTxtAreaEsconderFormulario();
});

btnCancelarAdicaoTarefa.addEventListener('click', limparTxtAreaEsconderFormulario);
